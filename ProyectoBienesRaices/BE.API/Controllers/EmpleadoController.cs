...
namespace BE.API.Controllers
{
    ...
    public class EmpleadoController : Controller
    {
        ...
        {
            var res = new BE.BS.Empleado(_context).GetAll();
        ...
        {
            var Empleado = new BE.BS.Empleado(_context).GetOneById(id);
        ...
        public async Task<ActionResult<models.Empleado>> PostEmpleado(models.Empleado Empleado)
        {
            try
            {
                data.Empleado mapaAux = _mapper.Map<models.Empleado, data.Empleado>(Empleado);//Rev
